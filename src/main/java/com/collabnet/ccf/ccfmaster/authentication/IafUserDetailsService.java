...
public class IafUserDetailsService implements AuthenticationUserDetailsService {
    ...
    private static final Logger log = LoggerFactory
                                            .getLogger(IafUserDetailsService.class);
    ...
    public UserDetails loadUserDetails(Authentication token)
        ...
        try {
            ...
            if (credentials.isLoggedIn()) {
                ...
                String linkId = connection.getIntegratedAppClient()
                        .getLinkPlugId(credentials.getProjectPath(),
                                credentials.getBaseUrl());
                return IafUserDetails.fromConnection(connection, "UNUSED",
                        "UNUSED", linkId, credentials.getProjectPath());
            } else {
                ...
                final Collection<GrantedAuthority> authorities = Collections
                        .emptySet();
                return TFUserDetails.fromConnection(connection, "UNUSED",
                        authorities);
            }

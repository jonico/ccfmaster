...
public class LinkedAppAuthenticationFilter extends
	...
	protected Object getPreAuthenticatedPrincipal(HttpServletRequest request) {
		boolean isLinkedAppRequest = hasParam(SF_LOGIN_TOKEN, request) && hasParam(SF_USERNAME, request);
	...
	protected Object getPreAuthenticatedCredentials(HttpServletRequest request) {
		...
		if (loginToken != null) {
			return new LinkedAppCredentials(loginToken, request.getParameter(SF_USERNAME));
		} else {
			return null;
		}
	}

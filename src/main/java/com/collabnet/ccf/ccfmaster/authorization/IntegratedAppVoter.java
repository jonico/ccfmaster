...
public class IntegratedAppVoter implements AccessDecisionVoter {
	...
	private static final Pattern linkIdPattern = Pattern.compile("^/linkid/(prpl\\d+)/");
	 ...
	 * <li>the request URL contains the principal's linkId attribute at the right place;</li>
	 * </ul>
	 * or else that:
	 * <ul>
	 * <li>the current principal is an instance of {@link TFUserDetails} and
	 * <li>the current principal's authorities include {@link TFUserDetails.SUPER_USER}.
	 * </ul>
	 * 

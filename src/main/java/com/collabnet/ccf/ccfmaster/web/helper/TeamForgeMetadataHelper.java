...
/**
 * TeamForgeMetadataHelper- provides util methods to retrieve TeamForge project
 * and tracker metadata information
 * 
 * @author kbalaji
 * 
 */
public class TeamForgeMetadataHelper {
    ...
    public static Map<String, String> getAllTeamForgeProjects()
        ...
        ProjectList projectList = connection.getTeamForgeClient()
                .getProjectList();
        ...
        Arrays.sort(projectRows, new Comparator<ProjectRow>() {
            public int compare(ProjectRow p1, ProjectRow p2) {
                return p1.getTitle().toLowerCase()
    ...
    public static List<Map<String, String>> getAllTrackersOfProject(
            String projectId) throws RemoteException {
        List<Map<String, String>> projectCollection = new ArrayList<Map<String, String>>();
        Connection connection = TeamForgeConnectionHelper.teamForgeConnection();
        TrackerList trackerList = connection.getTrackerClient().getTrackerList(
                projectId);
    ...
    public static Map<String, String> getTeamForgeProject(String projectPath)
            throws RemoteException {
        Map<String, String> projectInfoMap = new LinkedHashMap<String, String>();
        Connection connection = TeamForgeConnectionHelper.teamForgeConnection();
        ProjectDO project = connection.getTeamForgeClient()
                .getProjectDataByPath(projectPath);
        projectInfoMap.put(project.getId(), project.getTitle());
        return projectInfoMap;
    }

    public static String getTFLinkId(Connection connection, String plugId,
            String projectId) {
        try {
            IntegratedApplicationClient client = connection
                    .getIntegratedAppClient(true);
    ...
    public static ProjectDO getTFProjectDetails(Connection connection,
            String projectId) throws RemoteException {
        ProjectDO project = connection.getTeamForgeClient().getProjectData(
                projectId);
        return project;
    }

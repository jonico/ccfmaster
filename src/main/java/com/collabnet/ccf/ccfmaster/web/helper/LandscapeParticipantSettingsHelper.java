...
public class LandscapeParticipantSettingsHelper {
    ...
    public void makeModel(Model model,
        ...
        model.addAttribute("version", participantSettingsModel
                .getParticipantUrlParticipantConfig().getVersion());
        model.addAttribute("id", participantSettingsModel
                .getParticipantUrlParticipantConfig().getId());
        model.addAttribute("usernameversion", participantSettingsModel
                .getParticipantUserNameLandscapeConfig().getVersion());
        model.addAttribute("usernameid", participantSettingsModel
                .getParticipantUserNameLandscapeConfig().getId());
        model.addAttribute("passwordversion", participantSettingsModel
                .getParticipantPasswordLandscapeConfig().getVersion());
        ...
        if (participant.getSystemKind().equals(SystemKind.SWP)) {
            model.addAttribute("resyncusernameversion",
                    participantSettingsModel
                            .getParticipantResyncUserNameLandscapeConfig()
                            .getVersion());
            model.addAttribute("resyncusernameid", participantSettingsModel
                    .getParticipantResyncUserNameLandscapeConfig().getId());
            model.addAttribute("resyncpasswordversion",
                    participantSettingsModel
                            .getParticipantResyncPasswordLandscapeConfig()
                            .getVersion());
            model.addAttribute("resyncpasswordid", participantSettingsModel
                    .getParticipantResyncPasswordLandscapeConfig().getId());
        }
        model.addAttribute("participantversion", participantSettingsModel
                .getParticipant().getVersion());
        model.addAttribute("participantid", participantSettingsModel
                .getParticipant().getId());
        model.addAttribute("landscapeversion", participantSettingsModel
                .getLandscape().getVersion());
        model.addAttribute("landscapeid", participantSettingsModel
                .getLandscape().getId());
        model.addAttribute("participant",
                participantSettingsModel.getParticipant());
    }
    ...
    public void updateParticipantSettings(
        ...
        if (landscape.getParticipant().getSystemKind().equals(SystemKind.SWP)) {
            mergeSWPParticipantSettings(participantSettingsModel, request,
                    model, landscape);
        } else if ((landscape.getParticipant().getSystemKind()
                .equals(SystemKind.QC))) {
            //merge qc participant settings
            mergeQCPartcipantSettings(participantSettingsModel, request, model,
                    landscape);
        } else {
            mergeParticipantSettings(participantSettingsModel, request, model,
                    landscape);
        }
        model.addAttribute("qcsettingsmodel", participantSettingsModel);
        model.addAttribute("selectedLink", ControllerConstants.QCSETTINGS);
    ...
    private void makeParticipantSettingsModel(
        ...
        if (participant.getSystemKind().equals(SystemKind.QC)) {
            participantUrlParticipantConfig = (ParticipantConfig) ParticipantConfig
                    .findParticipantConfigsByParticipantAndName(participant,
                            ControllerConstants.CCF_PARTICIPANT_QC_URL)
                    .getSingleResult();
            participantUserNameLandscapeConfig = LandscapeConfig
                    .findLandscapeConfigsByLandscapeAndName(landscape,
                            ControllerConstants.CCF_LANDSCAPE_QC_USERNAME)
                    .getSingleResult();
            participantPasswordLandscapeConfig = LandscapeConfig
                    .findLandscapeConfigsByLandscapeAndName(landscape,
                            ControllerConstants.CCF_LANDSCAPE_QC_PASSWORD)
                    .getSingleResult();
            participantPasswordLandscapeConfig
                    .setVal(Obfuscator
                            .decodePassword(participantPasswordLandscapeConfig
                                    .getVal()));
        }
        ...
        if (participant.getSystemKind().equals(SystemKind.SWP)) {
            ...
            participantPasswordLandscapeConfig
                    .setVal(Obfuscator
                            .decodePassword(participantPasswordLandscapeConfig
                                    .getVal()));
            participantResyncUserNameLandscapeConfig = LandscapeConfig
                    .findLandscapeConfigsByLandscapeAndName(
                            landscape,
                            ControllerConstants.CCF_LANDSCAPE_SWP_RESYNC_USERNAME)
                    .getSingleResult();
            participantResyncPasswordLandscapeConfig = LandscapeConfig
                    .findLandscapeConfigsByLandscapeAndName(
                            landscape,
                            ControllerConstants.CCF_LANDSCAPE_SWP_RESYNC_PASSWORD)
                    .getSingleResult();
            participantResyncPasswordLandscapeConfig.setVal(Obfuscator
                    .decodePassword(participantResyncPasswordLandscapeConfig
                            .getVal()));
        }

        if (participant.getSystemKind().equals(SystemKind.GENERIC)) {
            List<CCFCoreProperty> landscapeConfigList = participantSettingsModel
                    .getLandscapeConfigList();
            List<CCFCoreProperty> participantConfigList = participantSettingsModel
                    .getParticipantConfigList();
            for (CCFCoreProperty property : landscapeConfigList) {
                String name = property.getName();
                LandscapeConfig config = LandscapeConfig
                        .findLandscapeConfigsByLandscapeAndName(landscape, name)
                        .getSingleResult();
            ...
            for (CCFCoreProperty property : participantConfigList) {
                ...
                ParticipantConfig config = ParticipantConfig
                        .findParticipantConfigsByParticipantAndName(
                                participant, name).getSingleResult();
                property.setValue(config.getVal());
        ...
        participantSettingsModel
                .setParticipantUrlParticipantConfig(participantUrlParticipantConfig);
        participantSettingsModel
                .setParticipantPasswordLandscapeConfig(participantPasswordLandscapeConfig);
        participantSettingsModel
                .setParticipantUserNameLandscapeConfig(participantUserNameLandscapeConfig);
        if (participant.getSystemKind().equals(SystemKind.SWP)) {
            participantSettingsModel
                    .setParticipantResyncUserNameLandscapeConfig(participantResyncUserNameLandscapeConfig);
            participantSettingsModel
                    .setParticipantResyncPasswordLandscapeConfig(participantResyncPasswordLandscapeConfig);
        }
    }

    private void mergeParticipantSettings(
            ParticipantSettingsModel participantSettingsModel,
            HttpServletRequest request, Model model, Landscape landscape) {
        Participant participant = landscape.getParticipant();
        //merge participantTimezone
        Participant participantTimezone = participantSettingsModel
                .getParticipant();
        participantTimezone.setId(Long.valueOf(request
                .getParameter(ControllerConstants.PARTICIPANT_ID)));
        participantTimezone.setVersion(Integer.parseInt(request
                .getParameter(ControllerConstants.PARTICIPANT_VERSION)));
    ...
    private void mergeQCPartcipantSettings(
        ...
        ParticipantConfig participantUrlParticipantConfig = ParticipantConfig
                .findParticipantConfigsByParticipantAndName(participant,
                        ControllerConstants.CCF_PARTICIPANT_QC_URL)
                .getSingleResult();
        participantUrlParticipantConfig.setVal(participantSettingsModel
                .getParticipantUrlParticipantConfig().getVal());
        participantUrlParticipantConfig.merge();

        //merge participantUsernameLandscapeConfig
        LandscapeConfig participantUsernameLandscapeConfig = LandscapeConfig
                .findLandscapeConfigsByLandscapeAndName(landscape,
                        ControllerConstants.CCF_LANDSCAPE_QC_USERNAME)
                .getSingleResult();
        participantUsernameLandscapeConfig.setVal(participantSettingsModel
        ...
        LandscapeConfig participantPasswordLandscapeConfig = LandscapeConfig
                .findLandscapeConfigsByLandscapeAndName(landscape,
                        ControllerConstants.CCF_LANDSCAPE_QC_PASSWORD)
                .getSingleResult();
        participantPasswordLandscapeConfig.setVal(Obfuscator
                .encodePassword(participantSettingsModel
    ...
    private void mergeSWPParticipantSettings(
        ...
        LandscapeConfig participantResyncUserNameLandscapeConfig = LandscapeConfig
                .findLandscapeConfigsByLandscapeAndName(landscape,
                        ControllerConstants.CCF_LANDSCAPE_SWP_RESYNC_USERNAME)
                .getSingleResult();
        participantResyncUserNameLandscapeConfig
                .setVal(participantSettingsModel
        ...
        LandscapeConfig participantResyncPasswordLandscapeConfig = LandscapeConfig
                .findLandscapeConfigsByLandscapeAndName(landscape,
                        ControllerConstants.CCF_LANDSCAPE_SWP_RESYNC_PASSWORD)
                .getSingleResult();
        participantResyncPasswordLandscapeConfig
                .setVal(Obfuscator
                        .encodePassword(participantSettingsModel
                                .getParticipantResyncPasswordLandscapeConfig()
                                .getVal()));

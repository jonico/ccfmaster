...
public class CreateLandscapeHelper {
    ...
    @Transactional
    public void createDirectionConfigs(Direction forwardDirection,
            Direction reverseDirection, Participant participant) {
        ...
        if (participant.getSystemKind().equals(SystemKind.QC)) {
            ...
            directionConfigLogTemplateQCtoTF
                    .setName(ControllerConstants.CCF_DIRECTION_LOGMESSAGETEMPLATE);
            directionConfigLogTemplateTFtoQC
                    .setName(ControllerConstants.CCF_DIRECTION_LOGMESSAGETEMPLATE);
            ...
            if (!isQCMaxAttachmentExist(reverseDirection)) {
                ...
                directionConfigQCMaxSize
                        .setName(ControllerConstants.CCF_DIRECTION_QC_MAX_ATTACHMENTSIZE);
                directionConfigQCMaxSize.setVal(ccfRuntimePropertyHolder
        ...
        if (participant.getSystemKind().equals(SystemKind.SWP)) {
            ...
            directionConfigLogTemplateTFtoSWP
                    .setName(ControllerConstants.CCF_DIRECTION_LOGMESSAGETEMPLATE);
            directionConfigLogTemplateSWPtoTF
                    .setName(ControllerConstants.CCF_DIRECTION_LOGMESSAGETEMPLATE);
            ...
            if (!isSWPMaxAttachmentExist(reverseDirection)) {
                ...
                directionConfigSWPMaxSize
                        .setName(ControllerConstants.CCF_DIRECTION_SWP_MAX_ATTACHMENTSIZE);
                directionConfigSWPMaxSize.setVal(ccfRuntimePropertyHolder
                        .getMaxAttachmentSize());
        ...
        if (participant.getSystemKind().equals(SystemKind.GENERIC)) {
            ...
            directionConfigLogTemplateTFtoGeneric
                    .setDirection(forwardDirection);
            directionConfigLogTemplateGenerictoTF
            ...
            if (genericParticipant != null
                ...
                directionConfigTFMaxSize.setVal(ccfRuntimePropertyHolder
                        .getMaxAttachmentSize());
        ...
        if (!isTFMaxAttachmentExist(forwardDirection)) {
            ...
            directionConfigTFMaxSize
                    .setName(ControllerConstants.CCF_DIRECTION_TF_MAX_ATTACHMENTSIZE);
            directionConfigTFMaxSize.setVal(ccfRuntimePropertyHolder
                    .getMaxAttachmentSize());
            directionConfigTFMaxSize.persist();
        }
    ...
    public void createDirections(Landscape landscape, Participant participant) {
        ...
        if (participant.getSystemKind().equals(SystemKind.QC)) {
            ...
            forwardDirection
                    .setDescription(ControllerConstants.TFTOGENERIC_DIRECTION_DESCRIPTION);
        }
        ...
        if (participant.getSystemKind().equals(SystemKind.QC)) {
            ...
            reverseDirection
                    .setDescription(ControllerConstants.GENERICTOTF_DIRECTION_DESCRIPTION);
        }
    ...
    public void persistModel(LandscapeModel landscapemodel) {
        ...
        ParticipantConfig urlParticipantconfig = landscapemodel
                .getParticipantUrlParticipantConfig();
        LandscapeConfig tfUserNameLandscapeConfig = landscapemodel
                .getTfUserNameLandscapeConfig();
        LandscapeConfig tfPasswordLandscapeConfig = landscapemodel
                .getTfPasswordLandscapeConfig();
        tfPasswordLandscapeConfig.setVal(Obfuscator
                .encodePassword(tfPasswordLandscapeConfig.getVal()));
        LandscapeConfig participantUserNameLandscapeConfig = landscapemodel
                .getParticipantUserNameLandscapeConfig();
        LandscapeConfig participantPasswordLandscapeConfig = landscapemodel
                .getParticipantPasswordLandscapeConfig();
        participantPasswordLandscapeConfig.setVal(Obfuscator
                .encodePassword(participantPasswordLandscapeConfig.getVal()));

        ParticipantConfig tfParticipantUrlParticipantconfig = new ParticipantConfig();
        tfParticipantUrlParticipantconfig
                .setName(ControllerConstants.CCF_PARTICIPANT_TF_URL);
        tfParticipantUrlParticipantconfig.setVal(ccfRuntimePropertyHolder
                .getTfUrl());
        ...
        if (participant.getSystemKind().equals(SystemKind.SWP)
                || participant.getSystemKind().equals(SystemKind.QC)) { // need to organize the loops
        ...
        if (participant.getSystemKind().equals(SystemKind.SWP)) {
            LandscapeConfig participantResyncUserNameLandscapeConfig = landscapemodel
                    .getParticipantResyncUserNameLandscapeConfig();
            LandscapeConfig participantResyncPasswordLandscapeConfig = landscapemodel
                    .getParticipantResyncPasswordLandscapeConfig();
            participantResyncPasswordLandscapeConfig.setVal(Obfuscator
                    .encodePassword(participantResyncPasswordLandscapeConfig
                            .getVal()));
            participantResyncUserNameLandscapeConfig.persist();
            participantResyncPasswordLandscapeConfig.persist();
        }
        if (participant.getSystemKind().equals(SystemKind.GENERIC)) {
            List<LandscapeConfig> landscapeCollection = GenericParticipantUtils
                    .buildLandscapeConfig(landscapemodel
                            .getLandscapeConfigList());
            List<ParticipantConfig> participantCollection = GenericParticipantUtils
                    .buildParticipantConfig(landscapemodel
    ...
    /**
     * Helper method to populate default values of participant and teamforge to
     * create landscape
     * 
     */
    public void populateCreateLandscapeModel(Model model,
    ...
    public boolean verifyDirectionEntities(Landscape landscape, Model model,
        ...
        if (Direction
            ...
            if (DirectionConfig
                ...
                model.addAttribute(
                        "errormessage",
                        context.getMessage(ControllerConstants.DIRECTION_CONFIG_ERROR_MESSAGE));
                return false;

            }
        } else {
            model.addAttribute("errormessage", context
                    .getMessage(ControllerConstants.DIRECTION_ERROR_MESSAGE));
            return false;
        }
    }

    public boolean verifyEntities(Landscape landscape, Model model,
            RequestContext context) {
        ...
        if (verifyDirectionEntities(landscape, model, context)) {
            Direction reverseDirection = Direction
                    .findDirectionsByLandscapeEqualsAndDirectionEquals(
                            landscape, Directions.REVERSE).getSingleResult();
            if (participant.getSystemKind().equals(SystemKind.QC)) {
                if (verifyQCEntities(landscape, reverseDirection, model,
                        context)) {
                    return false;
                }
            } else if (participant.getSystemKind().equals(SystemKind.SWP)) {
                if (verifySWPEntities(landscape, reverseDirection, model,
                        context)) {
                    return false;
                }
            } else if (participant.getSystemKind().equals(SystemKind.GENERIC)) {
                if (verifyGenericEntities(landscape, reverseDirection, model,
                        context)) {
                    return false;
                }
            }
    ...
    public boolean verifyQCEntities(Landscape landscape,
        ...
        if (ParticipantConfig
            ...
            model.addAttribute(
                    "errormessage",
                    context.getMessage(ControllerConstants.QUALITY_CENTER_ERROR_MESSAGE));
            return false;
        }
    }
    ...
    public boolean verifySWPEntities(Landscape landscape,
        ...
        if (ParticipantConfig
            ...
            model.addAttribute(
                    "errormessage",
                    context.getMessage(ControllerConstants.SCRUM_WORKS_PRO_ERROR_MESSAGE));
            return false;
        }
    }
    ...
    public boolean verifyTFEntities(Landscape landscape, Model model,
        ...
        if (LandscapeConfig
            ...
            model.addAttribute("errormessage", context
                    .getMessage(ControllerConstants.TEAMFORGE_ERROR_MESSAGE));
            return true;
        }
    }
    ...
    private boolean checkLandscapeConfigItemExist(Landscape landscape) {
        ...
        List<CCFCoreProperty> landscapeConfigList = genericParticipant
                .getGenericParticipantConfigItemFactory()
                .getLandscapeFieldList();
        for (int i = 0; i < landscapeConfigList.size()
                && isLandscapeConfigItemExist; i++) {
            CCFCoreProperty coreProperty = landscapeConfigList.get(i);
            isLandscapeConfigItemExist = LandscapeConfig
                    .findLandscapeConfigsByLandscapeAndName(landscape,
                            coreProperty.getName()).getResultList().size() != 0;
        }
    ...
    private boolean checkParticipantConfigItemExist(Landscape landscape) {
        ...
        List<CCFCoreProperty> participantConfigList = genericParticipant
                .getGenericParticipantConfigItemFactory()
                .getParticipantFieldList();
        for (int i = 0; i < participantConfigList.size()
                && isParticipantConfigItemExist; i++) {
            CCFCoreProperty coreProperty = participantConfigList.get(i);
            isParticipantConfigItemExist = ParticipantConfig
                    .findParticipantConfigsByParticipantAndName(
                            landscape.getParticipant(), coreProperty.getName())
                    .getResultList().size() != 0;
        }
        return isParticipantConfigItemExist;
    }

    public static boolean isGenericParticipantMaxAttachmentExist(
            Direction reverseDirection, String prefix) {
        String configName = String.format(
                "ccf.direction.%s.max.attachmentsize", prefix.toLowerCase());
        return DirectionConfig
                .findDirectionConfigsByDirectionAndName(reverseDirection,
                        configName).getResultList().size() != 0;
    }
    ...
    public static boolean isTFMaxAttachmentExist(Direction forwardDirection) {
        return DirectionConfig
                .findDirectionConfigsByDirectionAndName(forwardDirection,

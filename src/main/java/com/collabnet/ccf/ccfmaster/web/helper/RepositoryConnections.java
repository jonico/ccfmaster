...
public class RepositoryConnections {
	...
	static final class ArtifactDetailFinder implements Function<String, ArtifactDetail> {
		...
		static ArtifactDetail detailsForArtifactId(Connection teamforgeConnection, String artifactId) throws RemoteException {
	...
	static final class RepositoryDetailFinder implements Function<String, RepositoryDetail> {
		...
		static RepositoryDetail detailsFor(Connection teamforgeConnection, String tfRepositoryId) throws RemoteException {
	...
	public static RepositoryDetail detailsForRepository(String tfRepositoryId){
			try{ 
				...
				log.info("caught RemoteException while getting details for " + tfRepositoryId + ", returning dummy.", e);

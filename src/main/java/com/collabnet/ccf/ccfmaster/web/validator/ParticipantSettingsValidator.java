...
public class ParticipantSettingsValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        SystemKind participantKind = participantSettingsModel.getParticipant()
                .getSystemKind();
        ...
        if (participantKind.equals(SystemKind.QC)) {
            if (!participantSettingsModel.getParticipantUrlParticipantConfig()
                    .getVal().endsWith(ControllerConstants.VALIDATEQCURL)) {
        ...
        if (participantKind.equals(SystemKind.SWP)) {
            ...
            if (!participantSettingsModel.getParticipantUrlParticipantConfig()
                    .getVal().endsWith(ControllerConstants.VALIDATESWPURL)) {
                errors.rejectValue("participantUrlParticipantConfig.val",

...
public class ApiParticipantConfigController extends AbstractApiController<ParticipantConfig> {
    ...
    @Override
    public @ResponseBody
    ParticipantConfig create(@RequestBody ParticipantConfig requestBody,
            HttpServletResponse response) {
        requestBody.persist();
        setLocationHeader(response, Paths.PARTICIPANT_CONFIG + "/"
                + requestBody.getId());
        return requestBody;
    }
    ...
    @Override
    public @ResponseBody
    ParticipantConfigList list() {
        return new ParticipantConfigList(
                ParticipantConfig.findAllParticipantConfigs());
    }

    @Override
    public @ResponseBody
    ParticipantConfig show(@PathVariable("id") ParticipantConfig id) {
        return super.show(id);
    }

    @Override
    public void update(@PathVariable("id") Long id,
            @RequestBody ParticipantConfig requestBody,
            HttpServletResponse response) {

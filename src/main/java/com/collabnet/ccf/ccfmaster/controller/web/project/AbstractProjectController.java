...
public abstract class AbstractProjectController extends AbstractLandscapeController {
    ...
    public static final class MenuItem {
        ...
        public static MenuItem of(String link, String value, String tooltip,
                String role) {
    ...
    public List<MenuItem> populateMenu() {
        return Arrays
                .asList(MenuItem.of(ProjectIndexController.PROJECT_INDEX_PATH,
                        "index", "Home", "ROLE_IAF_USER"),
                        MenuItem.of(
                                ProjectRepositoryMappingController.PROJECT_REPOSITORY_MAPPING_PATH,
                                "repositorymappings", "Repository Mappings",
                        ...
                        MenuItem.of(
                                ...
                                "hospitalentrys", "Failed Shipments",
                                "ROLE_HOSPITAL"),
                        MenuItem.of(

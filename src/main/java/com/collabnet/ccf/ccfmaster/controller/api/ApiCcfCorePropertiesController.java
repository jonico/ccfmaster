...
public class ApiCcfCorePropertiesController extends AbstractBaseApiController {
    ...
    public @ResponseBody
    CCFCorePropertyList create(@RequestBody CCFCorePropertyList requestBody,
    ...
    CCFCorePropertyList show(@PathVariable("id") Long id) {
        ...
        try {
            ...
            List<CCFCoreProperty> propertyList = coreConfigLoader
    ...
    public void update(@PathVariable("id") Long id,
            @RequestBody CCFCorePropertyList requestBody,
            HttpServletResponse response) {

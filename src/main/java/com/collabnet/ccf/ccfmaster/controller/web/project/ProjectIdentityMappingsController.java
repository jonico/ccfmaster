...
public class ProjectIdentityMappingsController extends AbstractProjectController {
	...
	public static IdentityMappingsModel modelFor(IdentityMapping entry, String tfUrl) {
		...
		RepositoryDetail repositoryDetail = RepositoryConnections.detailsForRepository(entry.getRepositoryMapping().getTeamForgeRepositoryId());
	...
	public String saveDetails(
		...
		try{
			...
			log.debug("Error updating identity mapping details: " + exception.getMessage(), exception);

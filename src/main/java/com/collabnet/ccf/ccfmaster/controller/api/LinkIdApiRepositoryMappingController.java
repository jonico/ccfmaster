...
public class LinkIdApiRepositoryMappingController extends AbstractApiLinkIdController<RepositoryMapping> {
    ...
    RepositoryMapping create(
        ...
        setLocationHeader(
                response,
                Paths.LINKID_REPOSITORY_MAPPING.replace("{linkId}",
                        ea.getLinkId())
                        + "/" + requestBody.getId());
        return requestBody;
    }
    ...
    HospitalEntryList showHospitalEntries(
        ...
        return new HospitalEntryList(HospitalEntry
                .findHospitalEntrysByRepositoryMapping(rm).getResultList());
    }
    ...
    String showHospitalEntriesCount(
        ...
        return Long.toString(HospitalEntry
                .countHospitalEntrysByRepositoryMapping(rm));
    }
    ...
    HospitalEntryList showHospitalEntriesDirectionScope(
        ...
        validateRepositoryMapping(rm);
        return new HospitalEntryList(HospitalEntry
                .findHospitalEntrysByRepositoryMappingAndDirection(rm,
    ...
    String showHospitalEntriesDirectionScopeCount(
        ...
        validateRepositoryMapping(rm);
        return Long.toString(HospitalEntry
                .countHospitalEntrysByRepositoryMappingAndDirection(rm,
                        direction));
    }
    ...
    RepositoryMappingDirectionList showRepositoryMappingDirections(
        ...
        return new RepositoryMappingDirectionList(RepositoryMappingDirection
                .findRepositoryMappingDirectionsByRepositoryMapping(rm)
                .getResultList());
    }
    ...
    private void validateRequestBody(Long id, RepositoryMapping requestBody) {
        ...
        RepositoryMapping original = RepositoryMapping
                .findRepositoryMapping(id);

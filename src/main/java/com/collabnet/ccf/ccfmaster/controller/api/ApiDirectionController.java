...
public class ApiDirectionController extends AbstractApiController<Direction> {
    ...
    @Override
    public @ResponseBody
    Direction create(@RequestBody Direction requestBody,
    ...
    public @ResponseBody
    DirectionConfigList directionConfigs(@PathVariable("id") Direction direction) {
        return new DirectionConfigList(DirectionConfig
                .findDirectionConfigsByDirection(direction).getResultList());
    }
    ...
    public @ResponseBody
    DirectionList repositoryMappingDirections(
            @PathVariable("direction") Directions direction) {
        return new DirectionList(Direction.findDirectionsByDirection(direction)
                .getResultList());
    }
    ...
    public void update(@PathVariable("id") Long id,
            @RequestBody Direction requestBody, HttpServletResponse response) {

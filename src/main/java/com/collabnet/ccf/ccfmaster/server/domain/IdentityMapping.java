...
public class IdentityMapping {
    ...
    public static TypedQuery<IdentityMapping> findIdentityMappingsByExternalApp(ExternalApp externalApp) {
        ...
        TypedQuery<IdentityMapping> q = em.createQuery("SELECT IdentityMapping FROM IdentityMapping AS identitymapping WHERE identitymapping.repositoryMapping.externalApp = :externalApp", IdentityMapping.class);
    ...
    public static TypedQuery<IdentityMapping> findIdentityMappingsByLandscape(Landscape landscape) {
        ...
        EntityManager em = entityManager();
        TypedQuery<IdentityMapping> q = em.createQuery("SELECT IdentityMapping FROM IdentityMapping AS identitymapping WHERE identitymapping.repositoryMapping.externalApp.landscape = :landscape", IdentityMapping.class);

...
public class PropertiesLandscapeConfigPersisterFactory implements
	 ...
	 * 
	 * The files are located at ${ccf.home}/landscapeN/landscape.properties, where:
	 * <ul>
	...
	public Persister<LandscapeConfig> get(Landscape landscape) {
		...
		final PropertiesConfigItemPersister<LandscapeConfig> persister = new PropertiesConfigItemPersister<LandscapeConfig>(new File(propDir, fileName));

...
public class FieldMappingExternalAppTemplatePersisterFactoryImpl implements FieldMappingExternalAppTemplatePersisterFactory {
	...
	public FieldMappingExternalAppTemplatePersisterFactoryImpl(final String baseDirName) {
		this(new File(baseDirName));
	}

	public FieldMappingExternalAppTemplatePersisterFactoryImpl(final File baseDir) {
	...
	public Persister<FieldMappingExternalAppTemplate> get(ConversionResult conversionResult) {
		return new FieldMappingExternalAppTemplatePersister(baseDir, conversionResult);
	}

...
public class PreventLandscapeModificationLandscapeModificationListenerFactory implements LandscapeModificationListenerFactory {
            ...
            public Landscape beforeMerge(Landscape landscape) {
                ...
                if (!current.getName().equals(landscape.getName())) {
                    throw new CoreConfigurationException(
                            "modifying landscape.description is not allowed.");
                }
                return landscape;
            }

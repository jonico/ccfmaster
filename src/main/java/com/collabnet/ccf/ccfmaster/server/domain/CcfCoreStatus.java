...
public class CcfCoreStatus {
    public static enum CoreState {
        STARTING, STARTED, NOT_RESPONDING, STOPPING, STOPPED
    }
    ...
    @Autowired
    transient private CoreStateMachine                    doStuffStrategy;
    ...
    /*
     * non-javabean getter and setter to prevent Roo from exposing this in the
     * scaffolds >:-(
     */
    ...
    /**
     * because getCurrentStatus must be overridden for Roo compatibility, use
     * this for direct access to the field.
     */
    ...
    /*
     * !@#$ AspectJ tooling can't see these methods outside this class when
     * they're in a Roo ITD :-/
     */
    ...
    public static List<CcfCoreStatus> findCcfCoreStatusEntries(int firstResult,
            int maxResults) {
    ...
    public static TypedQuery<CcfCoreStatus> findCcfCoreStatusesByDirection(
        ...
        return new TypedQuery<CcfCoreStatus>() {
            ...
            @Override
            public TypedQuery<CcfCoreStatus> setFlushMode(
                    FlushModeType flushMode) {
                return this;
            }

            @Override
            public TypedQuery<CcfCoreStatus> setHint(String hintName,
                    Object value) {
                return this;
            }
            ...
            @Override
            public TypedQuery<CcfCoreStatus> setParameter(int position,
            ...
            @Override
            public TypedQuery<CcfCoreStatus> setParameter(
                    Parameter<Calendar> param, Calendar value,
            ...
            @Override
            public <T> TypedQuery<CcfCoreStatus> setParameter(
                    Parameter<T> param, T value) {
                return this;
            }

            @Override
            public TypedQuery<CcfCoreStatus> setParameter(String name,
                    Calendar value, TemporalType temporalType) {
                return this;
            }

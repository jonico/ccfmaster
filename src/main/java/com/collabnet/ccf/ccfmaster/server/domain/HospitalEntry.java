...
public class HospitalEntry {
    ...
    public static long countHospitalEntrysByExternalApp(ExternalApp ea) {
        return entityManager()
	        .createQuery("select count(o) from HospitalEntry o where o.repositoryMappingDirection.repositoryMapping.externalApp = :externalApp", Long.class)
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByExternalApp(ExternalApp externalApp) {
        ...
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp = :externalApp", HospitalEntry.class);
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByRepositoryMapping(RepositoryMapping rm) {
        ...
        EntityManager em = entityManager();
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping = :rm", HospitalEntry.class);
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByExternalAppAndDirection(ExternalApp externalApp, Directions direction) {
        ...
        EntityManager em = entityManager();
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp = :externalApp AND hospitalentry.repositoryMappingDirection.direction = :direction", HospitalEntry.class);
        q.setParameter("externalApp", externalApp);
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByRepositoryMappingAndDirection(RepositoryMapping rm, Directions direction) {
        ...
        if (direction == null) throw new IllegalArgumentException("The direction argument is required");
        EntityManager em = entityManager();
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping = :rm AND hospitalentry.repositoryMappingDirection.direction = :direction", HospitalEntry.class);
        q.setParameter("rm", rm);
        q.setParameter("direction", direction);
        return q;
    }
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByLandscape(Landscape landscape) {
        ...
        EntityManager em = entityManager();
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp.landscape = :landscape", HospitalEntry.class);
	...
	public static TypedQuery<HospitalEntry> findHospitalEntrysByLandscapeAndDirection(
        ...
        EntityManager em = entityManager();
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.direction = :direction AND hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp.landscape = :landscape", HospitalEntry.class);
        q.setParameter("landscape", landscape);
        q.setParameter("direction", direction);
        return q;
	}
	...
	public static TypedQuery<HospitalEntry> findHospitalEntrysByDirection(Directions direction) {
		Assert.notNull(direction, "The direction argument is required");
        EntityManager em = entityManager();
        TypedQuery<HospitalEntry> q = em.createQuery("SELECT HospitalEntry FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.direction = :direction", HospitalEntry.class);
        q.setParameter("direction", direction);
        return q;
	}

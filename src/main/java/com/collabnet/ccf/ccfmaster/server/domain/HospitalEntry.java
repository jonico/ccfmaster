...
public class HospitalEntry {
    ...
    public static long countHospitalEntrysByByDirectionAndSourceArtifactIdOrTargetArtifactId(
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.direction = :direction AND (hospitalentry.sourceArtifactId = :sourceArtifactId OR hospitalentry.targetArtifactId = :targetArtifactId)",
                        Long.class);
    ...
    public static long countHospitalEntrysByDirection(Directions direction) {
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.direction = :direction",
                        Long.class);
        q.setParameter("direction", direction);
        return q.getSingleResult();
    }
    ...
    public static long countHospitalEntrysByExternalApp(ExternalApp ea) {
        return entityManager()
                .createQuery(
                        "select count(o) from HospitalEntry o where o.repositoryMappingDirection.repositoryMapping.externalApp = :externalApp",
    ...
    public static long countHospitalEntrysByExternalAppAndDirection(
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp = :externalApp AND hospitalentry.repositoryMappingDirection.direction = :direction",
                        Long.class);
    ...
    public static long countHospitalEntrysByLandscape(Landscape landscape) {
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp.landscape = :landscape",
                        Long.class);
        q.setParameter("landscape", landscape);
        return q.getSingleResult();
    }

    public static long countHospitalEntrysByLandscapeAndDirection(
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.direction = :direction AND hospitalentry.repositoryMappingDirection.repositoryMapping.externalApp.landscape = :landscape",
                        Long.class);
        q.setParameter("landscape", landscape);
        q.setParameter("direction", direction);
        return q.getSingleResult();
    ...
    public static long countHospitalEntrysByRepositoryMapping(
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping = :rm",
                        Long.class);
    ...
    public static long countHospitalEntrysByRepositoryMappingAndDirection(
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection.repositoryMapping = :rm AND hospitalentry.repositoryMappingDirection.direction = :direction",
                        Long.class);
        q.setParameter("rm", rm);
        q.setParameter("direction", direction);
        return q.getSingleResult();
    ...
    public static long countHospitalEntrysByRepositoryMappingDirection(
        ...
        TypedQuery<Long> q = em
                .createQuery(
                        "SELECT COUNT(hospitalentry) FROM HospitalEntry AS hospitalentry WHERE hospitalentry.repositoryMappingDirection = :repositoryMappingDirection",
                        Long.class);
        q.setParameter("repositoryMappingDirection", repositoryMappingDirection);
        return q.getSingleResult();
    }

    public static TypedQuery<HospitalEntry> findHospitalEntrysByDirection(
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByDirectionAndSourceArtifactIdOrTargetArtifactId(
        ...
        TypedQuery<HospitalEntry> q = em
                .createQuery(
                        "SELECT o FROM HospitalEntry AS o WHERE o.repositoryMappingDirection.direction = :direction AND (o.sourceArtifactId = :sourceArtifactId OR o.targetArtifactId = :targetArtifactId) ORDER BY o.id",
                        HospitalEntry.class);
        q.setParameter("direction", direction);
        q.setParameter("sourceArtifactId", sourceArtifactId);
        q.setParameter("targetArtifactId", targetArtifactId);
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByLandscapeAndDirection(
            Landscape landscape, Directions direction) {
        Assert.notNull(landscape, "The landscape argument is required");
        Assert.notNull(direction, "The direction argument is required");
        EntityManager em = entityManager();
    ...
    public static TypedQuery<HospitalEntry> findHospitalEntrysByRepositoryMappingDirection(
        ...
        TypedQuery<HospitalEntry> q = em
                .createQuery(
                        "SELECT o FROM HospitalEntry AS o WHERE o.repositoryMappingDirection = :repositoryMappingDirection ORDER BY o.id",
                        HospitalEntry.class);
        q.setParameter("repositoryMappingDirection", repositoryMappingDirection);
        return q;
    }

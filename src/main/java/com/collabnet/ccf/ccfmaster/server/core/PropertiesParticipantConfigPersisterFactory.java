...
public class PropertiesParticipantConfigPersisterFactory implements
		PersisterFactory<ParticipantConfig, Participant>, ParticipantConfigPersisterFactory {
	...
	public Persister<ParticipantConfig> get(Participant participant) {
		String fileName = (participant.getSystemKind() + "-participant.properties").toLowerCase();
		final PropertiesConfigItemPersister<ParticipantConfig> persister = new PropertiesConfigItemPersister<ParticipantConfig>(new File(basePath, fileName ));

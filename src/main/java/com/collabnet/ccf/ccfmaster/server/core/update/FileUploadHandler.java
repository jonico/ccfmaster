...
public class FileUploadHandler extends MultiAction implements Serializable {
	...
	public Event checkVersion(RequestContext context) {
		CoreVersion coreVersion = czf.getVersion();
		CoreVersion landscapeVersion = CoreProperties.ofDirectory(landscapeDirectory).getVersion();
	...
	public CoreVersion getCurrentVersion() {

 ...
 */
public abstract class AbstractLandscapeModificationListener implements
		LandscapeModificationListener{
	
	private static Logger log = LoggerFactory.getLogger(AbstractLandscapeModificationListener.class);

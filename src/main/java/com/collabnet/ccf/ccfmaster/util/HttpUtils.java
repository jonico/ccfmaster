...
public final class HttpUtils {
    ...
    public static String buildContextUrl(HttpServletRequest request) {
        ...
        StringBuilder sb = new StringBuilder().append(scheme).append("://")
    ...
    public static boolean isDefaultPort(HttpServletRequest request) {
        String scheme = request.getScheme().toLowerCase();
        return (("http".equals(scheme) && request.getServerPort() == 80) || ("https"
                .equals(scheme) && request.getServerPort() == 443));
    }

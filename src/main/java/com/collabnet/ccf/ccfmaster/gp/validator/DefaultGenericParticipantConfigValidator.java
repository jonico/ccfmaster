...
public class DefaultGenericParticipantConfigValidator implements IGenericParticipantConfigItemValidator {
    ...
    public void validate(AbstractGenericParticipantModel model, Errors errors) {
        List<CCFCoreProperty> landscapeConfigList = model
                .getLandscapeConfigList();
        List<CCFCoreProperty> participantConfigList = model
                .getParticipantConfigList();
        ConfigItemValidatorUtils.validateValue(landscapeConfigList, errors,
                LANDSCAPE_CONFIG_LIST_ELEMENT_NAME);
        ConfigItemValidatorUtils.validateValue(participantConfigList, errors,
                PARTICIPANT_CONFIG_LIST_ELEMENT_NAME);
    }

    public ValidationResult validateConnection(
            AbstractGenericParticipantModel model) {
        return null;
    }

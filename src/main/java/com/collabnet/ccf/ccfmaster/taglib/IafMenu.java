	...
	private String getBanner(IafUserDetails user, HttpServletRequest request) throws ClientProtocolException, IOException, URISyntaxException {
		...
		for (String line : CharStreams.readLines(isr)) {
			buf.append(
					...
					.replace("<a class=\"yuimenubaritemlabel\"", "<a class=\"yuimenubaritemlabel\" target=\"_top\"")
					.replace("<a class=\"yuimensomeuitemlabel\"", "<a class=\"yuimensomeuitemlabel\" target=\"_top\"")
					.replace("<a class=\"yuimenuitemlabel\"", "<a class=\"yuimenuitemlabel\" target=\"_top\"")

...
public class CCFMasterBackUp {
    ...
    public void setStartCoresOnBootBean(
            StartCoresOnBootBean startCoresOnBootBean) {
    ...
    protected synchronized void doDBBackup(File destDir) {
        try {
            ...
            throw new CoreConfigurationException(
                    "Accessed denied to Backup Files", e);
        } catch (IOException e) {
            throw new CoreConfigurationException("Backup operation failed- "
                    + e.getMessage(), e);
        }
    ...
    private File[] loadParticipantPropFiles() {
        ...
        return dir.listFiles(new FilenameFilter() {
            private String[] regexs = { "^.*-participant\\.properties",

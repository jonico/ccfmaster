...
public class FieldMappingUtil {
    ...
    /**
     * create copy of new fieldmappingrule object where id and version of the
     * given object are excluded.
     * 
     ...
     * @return
     */
    public static List<FieldMappingRule> createFieldMappingRule(
        ...
        for (FieldMappingRule fmrules : rules) {
            ...
            fieldMappingRule.setSourceIsTopLevelAttribute(fmrules
                    .isSourceIsTopLevelAttribute());
            fieldMappingRule.setTargetIsTopLevelAttribute(fmrules
    ...
    /**
     * create copy of new fieldmappingvaluemap object where id and version of
     * the given object are excluded.
     * 
     ...
     * @return
     */
    public static List<FieldMappingValueMap> createFieldMappingValueMap(
            List<FieldMappingValueMap> valueMap) {
        ...
        for (FieldMappingValueMap fmvaluemaps : valueMap) {
            ...
            List<FieldMappingValueMapEntry> fieldMappingValueMapEntry = createFieldMappingValueMapEntry(fmvaluemaps
                    .getEntries());
    ...
    /**
     * create copy of new fieldmappingvaluemapentry object where id and version
     * of the given object are excluded.
     * 
     * @param FieldMappingValueMap
     * @param valueMap
     * @param FieldMappingValueMap
     * @return
     */
    public static List<FieldMappingValueMapEntry> createFieldMappingValueMapEntry(
            List<FieldMappingValueMapEntry> valueMapEntry) {

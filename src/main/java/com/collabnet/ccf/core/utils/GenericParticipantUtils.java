...
/**
 * GenericParticipantUtils provides util methods to handle participant to config
 * objects
 * 
 * @author kbalaji
 * 
...
public class GenericParticipantUtils {
    ...
    public static List<DirectionConfig> buildDirectionConfig(
            List<CCFCoreProperty> directionConfigList) {
    ...
    public static List<LandscapeConfig> buildLandscapeConfig(
            List<CCFCoreProperty> landscapeConfigList) {
    ...
    public static List<ParticipantConfig> buildParticipantConfig(

...
public class QCSettings extends CcfAuthenticatedTestBase {
	...
	public void testQcLogs() {
		...
		selenium.waitForPageToLoad("30000");
		for(int i=0 ; i<15000 ;i++){// this will invoke ajax request-to load tail log file content
	...
	public void connectorUpgrade(){
		...
		selenium.click("id=fileSelectUpgradeOption");
		selenium.type("id=coreFileUploader", "C:\\Selenium automated\\invalid.zip");
		selenium.click("name=_eventId_upload");
		selenium.waitForPageToLoad("30000");
		verifyTrue(selenium.isTextPresent("Bad Zip File."));
		selenium.click("id=fileSelectUpgradeOption");
		selenium.type("id=coreFileUploader", "C:\\Selenium automated\\valid.zip");
		selenium.click("name=_eventId_upload");
		selenium.waitForPageToLoad("30000");
		verifyTrue(selenium.isTextPresent("uploaded core (version 2.0.0 ($Revision$)) was not newer than existing landscape"));
		selenium.click("id=fileSelectUpgradeOption");
		selenium.type("id=coreFileUploader", "C:\\Selenium automated\\valid-higherVersion.zip");
		selenium.click("name=_eventId_upload");
		selenium.waitForPageToLoad("30000");

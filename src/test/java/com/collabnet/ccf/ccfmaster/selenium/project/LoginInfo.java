...
public class LoginInfo {
    ...
    public void login(Selenium selenium) {
        String user = linkId == null ? userName : String.format("%s/%s",
                userName, linkId);
    ...
    public String toString() {
        return String.format("LoginInfo(%s, %s, %s)", userName, password,
                linkId);
    }
    ...
    public static LoginInfo projectHospitalScopeFromSystemProperties() {
        String user = System.getProperty(HOSPITAL_USERNAME_SYSTEM_PROPERTY,
                "seleniumhospital");
    ...
    public static LoginInfo projectIdentityMappingScopeFromSystemProperties() {
        String user = System.getProperty(IDMAPPING_USERNAME_SYSTEM_PROPERTY,
                "seleniumidmapping");
    ...
    public static LoginInfo projectRepositoryMappingScopeFromSystemProperties() {
        String user = System.getProperty(REPO_MAPPING_USERNAME_SYSTEM_PROPERTY,
                "seleniumrepomapping");

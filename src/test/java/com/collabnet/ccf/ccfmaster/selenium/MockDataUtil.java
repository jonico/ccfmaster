...
public class MockDataUtil {
	...
	private static final Logger log = LoggerFactory.getLogger(MockDataUtil.class);

	public static void createExternalApp(Selenium selenium, String linkId) {
...
*/		
	...
	public static void createRepositoryMappingAndRepositoryMappingDirection(Selenium selenium) {
		...
		final String tfRepoId = "tracker1056";
		...
		final String lastSourceArtifactId = "artf1122";
...
//		selenium.click("//table[@id='_lastSourceArtifactModificationDate_id_popup']/tbody/tr[3]/td[3]/span");
	...
	public static void createFailedShipments(Selenium selenium) {
		...
		final String sourceArtifactId = "artf1122";

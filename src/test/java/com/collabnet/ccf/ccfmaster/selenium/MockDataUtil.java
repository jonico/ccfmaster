...
public class MockDataUtil {
    ...
    public static void createExternalApp(Selenium selenium) {
         ...
         * selenium.waitForPageToLoad("30000"); selenium.type("id=_linkId_id",
         * linkId); final String projectPath =
         * "projects.brokerage_system_sample";
         * selenium.type("id=_projectPath_id", projectPath);
         * selenium.type("id=_projectTitle_id", "external app");
         * selenium.click("id=proceed"); selenium.waitForPageToLoad("30000");
         */
    }
    ...
    public static void createIdentityMapping(Selenium selenium) {
        ...
        String sourceLastModificationTimeStr = dateFormat
                .format(sourceLastModificationTime);
        selenium.type("id=_sourceLastModificationTime_id",
                sourceLastModificationTimeStr);
        String targetLastModificationTimeStr = dateFormat
                .format(targetLastModificationTime);
        selenium.type("id=_targetLastModificationTime_id",
                targetLastModificationTimeStr);
    ...
    public static void createRepositoryMappingAndRepositoryMappingDirection(
        ...
        createRepositoryMappingDirection(selenium, direction,
                ...
                lastSourceArtifactModificationDate);
    }
    ...
    static void createRepositoryMappingDirection(Selenium selenium,
            Directions direction, final String lastSourceArtifactVersion,
            final String lastSourceArtifactId,
            final Date lastSourceArtifactModificationDate) {
        ...
        selenium.type("id=_lastSourceArtifactVersion_id",
                lastSourceArtifactVersion);

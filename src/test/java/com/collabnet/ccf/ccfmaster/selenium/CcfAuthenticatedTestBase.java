...
public class CcfAuthenticatedTestBase extends CcfSeleneseTestBase {
	...
	static {
		 ...
		 */
		staticUsername = System.getProperty(LoginInfo.USERNAME_SYSTEM_PROPERTY, "admin");
		staticPassword = System.getProperty(LoginInfo.PASSWORD_SYSTEM_PROPERTY, "admin");
	}
	 ...
	 * {@link LoginInfo#PASSWORD_SYSTEM_PROPERTY}. If not set, uses "admin" for both.
	 */

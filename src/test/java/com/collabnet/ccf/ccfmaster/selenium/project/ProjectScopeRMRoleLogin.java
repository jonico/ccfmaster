...
public class ProjectScopeRMRoleLogin extends ProjectScopeTestBase{
	...
	public ProjectScopeRMRoleLogin() {
		super();
		LoginInfo user = LoginInfo.projectRepositoryMappingScopeFromSystemProperties();
		user.login(selenium);
	}
	...
	public void checkRoles() {
		...
		assertThat(roles, hasItems("ROLE_REPOSITORY_MAPPINGS","ROLE_PAUSE_SYNCHRONIZATION","ROLE_IAF_USER","ROLE_TF_USER"));
	}

...
@SuiteClasses({ ProjectIndexPage.class, ProjectScopeHospitalRoleLogin.class,
        ProjectRepositoryMappingsPage.class, ProjectScopeRMRoleLogin.class,
        ProjectScopeIdMappingRoleLogin.class,
        ProjectIdentityMappingsPage.class, ProjectFieldMappingsPage.class })
public class QCProjectSettingsIT {
    private static final Logger log = LoggerFactory
                                            .getLogger(QCProjectSettingsIT.class);
    ...
    public static void createLandscape() {
        try {
            ...
            assertThat(selenium.getLocation(),
                    containsString(ProjectIndexController.PROJECT_INDEX_PATH));
            MockDataUtil

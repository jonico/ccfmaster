...
public class ProjectScopeTestBase extends CcfSeleneseTestBase {
    ...
    protected final Logger    log = LoggerFactory
                                          .getLogger(ProjectScopeTestBase.class);
    ...
    /**
     * @return the WebElement that corresponds to the selected menu entry in the
     *         left menu bar
     */
    protected WebElement activeMenuEntry() {
        return driver.findElement(By
                .cssSelector("div.ImageListParentSelectedNoTop"));
    }
}

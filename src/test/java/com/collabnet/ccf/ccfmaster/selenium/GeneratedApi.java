...
public class GeneratedApi extends CcfAuthenticatedTestBase {
	...
	/**
	 * deletes all participants using the scaffold UI and creates a new
	 * SWP landscape.
	 */
	@BeforeClass
	...
	public void apiGetLandscapeConfig() {
		...
		if (selenium.isElementPresent("//landscapeConfigList/landscapeConfig/id")) {
	...
	public void apiGetIdentityMapping() {
		...
		if (selenium.isElementPresent("//identityMappingList/identityMapping/id")) {
	...
	public void apiGetDirectionConfig() {
		...
		if (selenium.isElementPresent("//directionConfigList/directionConfig/id")) {
	...
	public void apiGetParticipantConfig() {
		...
		if (selenium.isElementPresent("//participantConfigList/participantConfig/id")) {
	...
	public void apiGetRepositoryMapping() {
		...
		if (selenium.isElementPresent("//repositoryMappingList/repositoryMapping/id")) {
	...
	public void apiGetRepositoryMappingDirection() {
		...
		verifyTrue(selenium.isElementPresent("//repositoryMappingDirectionList"));
		if (selenium.isElementPresent("//repositoryMappingDirectionList/repositoryMappingDirection/id")) {
			String entityId = selenium.getText("//repositoryMappingDirection/id[1]");
			selenium.open("/CCFMaster/api/repositorymappingdirections/" + entityId);
			verifyTrue(selenium.isElementPresent("//repositoryMappingDirection/id"));
		}
		selenium.open("/CCFMaster/api/repositorymappingdirections");
		verifyTrue(selenium.isElementPresent("//h1"));
	}
	...
	public void apiGetFieldMappingExternalAppTemplate() {
		...
		verifyTrue(selenium.isElementPresent("//fieldMappingExternalAppTemplateList"));
		if (selenium.isElementPresent("//fieldMappingExternalAppTemplateList/fieldMappingExternalAppTemplate/id")) {
			String entityId = selenium.getText("//fieldMappingExternalAppTemplate/id[1]");
			selenium.open("/CCFMaster/api/fieldmappingexternalapptemplates/" + entityId);
			verifyTrue(selenium.isElementPresent("//fieldMappingExternalAppTemplate/id"));
		}
		selenium.open("/CCFMaster/api/fieldmappingexternalapptemplates");
		verifyTrue(selenium.isElementPresent("//h1"));
	}
	...
	public void apiGetFieldMappingLandscapeTemplate() {
		...
		verifyTrue(selenium.isElementPresent("//fieldMappingLandscapeTemplateList"));
		if (selenium.isElementPresent("//fieldMappingLandscapeTemplateList/fieldMappingLandscapeTemplate/id")) {
			String entityId = selenium.getText("//fieldMappingLandscapeTemplate/id[1]");
			selenium.open("/CCFMaster/api/fieldmappinglandscapetemplates/" + entityId);
			verifyTrue(selenium.isElementPresent("//fieldMappingLandscapeTemplate/id"));
		}
		selenium.open("/CCFMaster/api/fieldmappinglandscapetemplates");
		verifyTrue(selenium.isElementPresent("//h1"));
	}

...
public class MockLandscapeModificationListenerFactory implements
		LandscapeModificationListenerFactory {
	private static Logger log = LoggerFactory.getLogger(MockLandscapeModificationListenerFactory.class);

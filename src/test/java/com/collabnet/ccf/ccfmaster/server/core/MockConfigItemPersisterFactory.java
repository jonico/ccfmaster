...
public class MockConfigItemPersisterFactory<T extends ConfigItem, U> implements
		PersisterFactory<T, U> {

	private static final Logger log = LoggerFactory.getLogger(MockConfigItemPersisterFactory.class);

...
public class PropertiesDirectionConfigPersisterFactoryTest  extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void checkFileName() {
		...
		PropertiesDirectionConfigPersisterFactory factory = new PropertiesDirectionConfigPersisterFactory(baseDir);

		final PropertiesConfigItemPersister<DirectionConfig> persister = (PropertiesConfigItemPersister<DirectionConfig>) factory.get(direction);

...
public class RepositoryMappingDirectionDataOnDemand {
    ...
    public RepositoryMappingDirection getNewTransientRepositoryMappingDirection(
            int index) {
        ...
        obj.setConflictResolutionPolicy(com.collabnet.ccf.ccfmaster.server.domain.ConflictResolutionPolicy.class
                .getEnumConstants()[0]);
        ...
        obj.setRepositoryMapping(repositoryMappingDataOnDemand

...
public class ConversionResultMappingRulesTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testConditionalConstantMappingRule() {
        ...
        FieldMappingRule rule = getRule(
                FieldMappingRuleType.CONDITIONAL_CONSTANT, false);
    ...
    public void testConditionalConstantTlaMappingRule() {
        final FieldMapping fm = getMappingRulesFieldMapping();
        FieldMappingRule rule = getRule(
                FieldMappingRuleType.CONDITIONAL_CONSTANT, true);
        fm.getRules().add(rule);
    ...
    public void testConditionalFieldMappingRule() {
        final FieldMapping fm = getMappingRulesFieldMapping();
        FieldMappingRule rule = getRule(FieldMappingRuleType.CONDITIONAL_FIELD,
                false);
        fm.getRules().add(rule);
    ...
    public void testDirectConstantMappingRule() {
        final FieldMapping fm = getMappingRulesFieldMapping();
        FieldMappingRule rule = getRule(FieldMappingRuleType.DIRECT_CONSTANT,
                false);
        fm.getRules().add(rule);
    ...
    public void testDirectFieldMappingRule() {
        final FieldMapping fm = getMappingRulesFieldMapping();
        FieldMappingRule rule = getRule(FieldMappingRuleType.DIRECT_FIELD,
                false);
        fm.getRules().add(rule);
    ...
    public void testSourceRepositoryMappingRule() {
        ...
        final FieldMapping fm = getMappingRulesFieldMapping();
        FieldMappingRule rule = getRule(
                FieldMappingRuleType.SOURCE_REPOSITORY_LAYOUT, true);
        rule.setXmlContent(xmlContent);
        fm.getRules().add(rule);
        ConversionResult res = resultFactory.get(fm);
    ...
    public void testTargetRepositoryMappingRule() {
        ...
        final FieldMapping fm = getMappingRulesFieldMapping();
        FieldMappingRule rule = getRule(
                FieldMappingRuleType.TARGET_REPOSITORY_LAYOUT, true);
        rule.setXmlContent(xmlContent);
        fm.getRules().add(rule);
        ConversionResult res = resultFactory.get(fm);

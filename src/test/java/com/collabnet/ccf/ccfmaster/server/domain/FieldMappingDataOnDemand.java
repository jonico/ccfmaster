...
public class FieldMappingDataOnDemand {
    ...
    public FieldMapping getNewTransientFieldMapping(int index) {
        ...
        obj.setParent(repositoryMappingDirectionDataOnDemand
    ...
    public static void processMappingKind(Mapping<?> obj) {
        switch (obj.getKind()) {
            case CUSTOM_XSLT:
                ...
                customXsltRule
                        .setType(FieldMappingRuleType.CUSTOM_XSLT_DOCUMENT);
            ...
            case MAPFORCE:
                ...
                sourceLayout
                        .setType(FieldMappingRuleType.SOURCE_REPOSITORY_LAYOUT);
                ...
                targetLayout
                        .setType(FieldMappingRuleType.TARGET_REPOSITORY_LAYOUT);

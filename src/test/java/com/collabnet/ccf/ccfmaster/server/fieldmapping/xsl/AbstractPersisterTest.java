...
public class AbstractPersisterTest {
    ...
    public void callingNonWhiteListedMethodsFails() throws IOException,
            DocumentException {
        for (String resourceName : ImmutableList
                .of("non-whitelisted-method.xsl")) {
            try {
    ...
    @Test
    public void xsltCanCallWhiteListedMethods() throws DocumentException,
    ...
    private ConversionResult str2ConversionResult(final String xslt)
    ...
    private void validateResource(final String fileName) throws IOException,
            CoreConfigurationException, DocumentException {
        URL xsltLocation = Resources.getResource(AbstractPersisterTest.class,
                fileName);

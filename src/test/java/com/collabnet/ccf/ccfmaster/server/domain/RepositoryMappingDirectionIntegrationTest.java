...
public class RepositoryMappingDirectionIntegrationTest {
	...
	public void invalidParentThrowsException() {
		RepositoryMappingDirection rmd1 = dod.getSpecificRepositoryMappingDirection(0);
		RepositoryMappingDirection rmd2 = dod.getSpecificRepositoryMappingDirection(1);
	...
	public void removeWhileFieldMappingStillActive() {
		...
		//rmd.remove();
		fm.remove();
		rmd = RepositoryMappingDirection.findRepositoryMappingDirection(rmd.getId());

...
public class CreateIntegratedAppStrategyTest2 {
	...
	@Mocked com.collabnet.ce.soap50.webservices.ClientSoapStubFactory stubFactorySoap50;
	@Mocked com.collabnet.ce.soap60.webservices.ClientSoapStubFactory stubFactorySoap60;
	...
	private class TestIntegratedApplicationClient extends IntegratedApplicationClient {
		...
		@Override
		public PluggableComponentDO createIntegratedApplication(String plugName,
				String description, String baseUrl, String goUrl,
				String prefix, String isScmRequired, String requireProjPrefix,
				String iconFileId, String endPoint,
	...
	public void createAndGetAppByNameNotCalledWhenIAExists() {
		...
		new CreateIntegratedAppStrategy("foo", "iafEndpoint", client).beforeCreate(landscape);
		assertFalse("createIntegratedApplication was called", createCalled);
		assertFalse("getIntegratedApplicationByName was called", getAppByNameCalled);
		assertEquals("plugId not set correctly by beforeCreate", plugId, landscape.getPlugId());

...
public class CcfCoreStatusIntegrationTest {
    ...
    public void testCountCcfCoreStatuses() {
        ...
        org.junit.Assert
                .assertTrue(
                        "Counter for 'CcfCoreStatus' incorrectly reported there were no entries",
                        count > 0);
    }
    ...
    public void testFindAllCcfCoreStatuses() {
        ...
        org.junit.Assert
                .assertTrue(
                        "Too expensive to perform a find all test for 'CcfCoreStatus', as there are "
                                + count
    ...
    public void testFindCcfCoreStatusEntries() {
        ...
        org.junit.Assert
                .assertNotNull(
                        "Find entries method for 'CcfCoreStatus' illegally returned null",
                        result);
        org.junit.Assert
                .assertEquals(
                        "Find entries method for 'CcfCoreStatus' returned an incorrect number of entries",
                        count, result.size());
    }
    ...
    public void testMerge() {
        ...
        org.junit.Assert
                .assertTrue(
                        "Version for 'CcfCoreStatus' failed to increment on merge and flush directive",
                        (currentVersion != null && obj.getVersion() > currentVersion)
                                || !modified);
    }

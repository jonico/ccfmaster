...
public class ParticipantDataOnDemand {
	...
	public Participant getNewTransientParticipant(int index) {
        ...
        SystemKind systemKind = (index % 2 == 0) ? SystemKind.TF : SystemKind.SWP;
        ...
        obj.setTimezone(Timezone.class.getEnumConstants()[rnd.nextInt(Timezone.class.getEnumConstants().length)]);
        return obj;
    }

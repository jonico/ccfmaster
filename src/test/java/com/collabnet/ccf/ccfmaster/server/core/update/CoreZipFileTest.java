...
public class CoreZipFileTest {
	...
	private void writeCorePropFile(File propFile, Version version, String desc) throws FileNotFoundException,
			IOException {
		Properties props = new Properties();
		props.setProperty(Version.CCFCORE_MAJOR_VERSION, Integer.toString(version.getMajor()));
		props.setProperty(Version.CCFCORE_MINOR_VERSION, Integer.toString(version.getMinor()));
		props.setProperty(Version.CCFCORE_PATCH_VERSION, Integer.toString(version.getPatch()));
		props.setProperty(Version.CCFCORE_REVISION_STRING, version.getRevision());

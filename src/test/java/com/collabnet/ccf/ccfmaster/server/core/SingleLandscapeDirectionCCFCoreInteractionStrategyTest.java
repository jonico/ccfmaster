...
public class SingleLandscapeDirectionCCFCoreInteractionStrategyTest extends
	...
	private String[] propertyNames = { WRAPPER_JAVA_ADDITIONAL_2, TESTPROPERTY };
	...
	public void testCreateWithDBForward() throws IOException {
		...
		testCreateWithDB(propertyNames,
				new String[] { "-Dcom.sun.management.jmxremote.port=8001", direction.getDescription() });
	}
	...
	public void testCreateWithDBReverse() throws IOException {
		...
		testCreateWithDB(propertyNames,
				new String[] { "-Dcom.sun.management.jmxremote.port=8002", direction.getDescription() });
	}
	...
	public void testUpdateWithDBForward() throws IOException {
		...
		direction.merge();
		testCreateWithDB(propertyNames, new String[] { "-Dcom.sun.management.jmxremote.port=8001",
				updatedDescription });
	}
	...
	public void testUpdateWithDBReverse() throws IOException {
		...
		direction.setDescription(updatedDescription);
		direction.merge();
		testCreateWithDB(propertyNames, new String[] { "-Dcom.sun.management.jmxremote.port=8002",
				updatedDescription });
	}

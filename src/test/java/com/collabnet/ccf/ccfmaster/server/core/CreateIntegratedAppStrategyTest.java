...
public class CreateIntegratedAppStrategyTest {
	...
	private class TestIntegratedApplicationClient extends IntegratedApplicationClient {
		...
		@Override 
		public void setPluggableAppMessageResource(String plugId, String locale, String key, String value) throws RemoteException {
	...
	public void createCalledAndGetAppByNameNotCalledWhenIADoesNotExist() {
		...
		new CreateIntegratedAppStrategy(baseUrl, "iafEndpoint", client).beforeCreate(landscape);
		...
		assertEquals("bad adminUrl", baseUrl + UIPathConstants.CREATELANDSCAPE_CCFMASTER, adminUrl);

...
public class CcfCoreStatusDataOnDemand {
    ...
    /*
     * the @SuppressWarnings("unused") are there so Roo doesn't think it's
     * responsible
     */
    ...
    private void setDirection(CcfCoreStatus obj, int index) {
        com.collabnet.ccf.ccfmaster.server.domain.Direction direction = directionDataOnDemand
                .getSpecificDirection(index);

...
public class RepositoryMappingLinkIdAPIIntegrationTest extends AbstractAPIIntegrationTest {
    ...
    public void testFind() {
        ...
        String linkIdPathSegment = "/linkid/" + obj.getExternalApp().getLinkId() + "/repositorymappings/";  
        obj = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment +  id, RepositoryMapping.class);
    ...
    public void testCount() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMapping obj = dod.getRandomRepositoryMapping();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMapping' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.RepositoryMapping.countRepositoryMappingsByExternalApp(obj.getExternalApp());
        String linkIdPathSegment = "/linkid/" + obj.getExternalApp().getLinkId() + "/repositorymappings/";
        List<RepositoryMapping> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment, RepositoryMappingList.class);
    ...
    public void testWithWrongParentIdInPath() {
        ...
        ExternalApp ea = dodEA.getNewTransientExternalApp(42);
        ea.persist();
        String linkIdPathSegment = "/linkid/" + ea.getLinkId() + "/repositorymappings/";
    ...
    public void testCreate() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMapping randomObject = dod.getRandomRepositoryMapping();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMapping' failed to initialize correctly", randomObject);
    	String linkIdPathSegment = "/linkid/" + randomObject.getExternalApp().getLinkId() + "/repositorymappings/";
        ...
        obj = restTemplate.postForObject(ccfAPIUrl + linkIdPathSegment, obj, RepositoryMapping.class);

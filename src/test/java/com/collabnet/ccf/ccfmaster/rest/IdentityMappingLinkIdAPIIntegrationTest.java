...
public class IdentityMappingLinkIdAPIIntegrationTest extends AbstractAPIIntegrationTest {
    ...
    public void testFind() {
        ...
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/identitymappings/";  
        obj = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment +  id, IdentityMapping.class);
    ...
    public void testCount() {
    	com.collabnet.ccf.ccfmaster.server.domain.IdentityMapping obj = dod.getRandomIdentityMapping();
    	org.junit.Assert.assertNotNull("Data on demand for 'IdentityMapping' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.IdentityMapping.countIdentityMappingsByExternalApp(obj.getRepositoryMapping().getExternalApp());
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/identitymappings/";
        List<IdentityMapping> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment, IdentityMappingList.class);
    ...
    public void testCountRepositoryMappingScope() {
    	com.collabnet.ccf.ccfmaster.server.domain.IdentityMapping obj = dod.getRandomIdentityMapping();
    	org.junit.Assert.assertNotNull("Data on demand for 'IdentityMapping' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.IdentityMapping.countIdentityMappingsByRepositoryMapping(obj.getRepositoryMapping());
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/repositorymappings/" + obj.getRepositoryMapping().getId() + "/identitymappings/";
        List<IdentityMapping> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment, IdentityMappingList.class);
        org.junit.Assert.assertTrue("Counter for 'IdentityMapping' incorrectly reported there were no entries", count > 0);
        org.junit.Assert.assertNotNull("Find entries method for 'IdentityMapping' illegally returned null", result);
        org.junit.Assert.assertEquals("Find entries method for 'IdentityMapping' returned an incorrect number of entries", count, result.size());
    ...
    public void testUpdate() {
        ...
        restTemplate.put(ccfAPIUrl +  linkIdPathSegment + id, obj);
        obj = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment + id, IdentityMapping.class);
        org.junit.Assert.assertFalse("source artifact id should be immutable", "foo".equals(obj.getSourceArtifactId()));
        org.junit.Assert.assertFalse("target artifact id should be immutable", "bar".equals(obj.getTargetArtifactId()));
        org.junit.Assert.assertTrue("last modification time should be changeable", currentDate.equals(obj.getTargetLastModificationTime()));
    }
    ...
    public void testReGrandparenting() {
        ...
        org.junit.Assert.assertNotNull("Find method for 'IdentityMapping' illegally returned null for id '" + id + "'", obj);
        String linkIdPathSegment = "/linkid/" + ea.getLinkId() + "/identitymappings/";
    ...
    public void testCreate() {
    	com.collabnet.ccf.ccfmaster.server.domain.IdentityMapping randomObject = dod.getRandomIdentityMapping();
    	org.junit.Assert.assertNotNull("Data on demand for 'IdentityMapping' failed to initialize correctly", randomObject);
    	String linkIdPathSegment = "/linkid/" + randomObject.getRepositoryMapping().getExternalApp().getLinkId() + "/identitymappings/";
        ...
        obj = restTemplate.postForObject(ccfAPIUrl + linkIdPathSegment, obj, IdentityMapping.class);

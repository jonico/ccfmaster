...
public class RepositoryMappingDirectionLinkIdAPIIntegrationTest extends AbstractAPIIntegrationTest {
    ...
    public void testFind() {
        ...
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/repositorymappingdirections/";  
    ...
    public void testCount() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection obj = dod.getRandomRepositoryMappingDirection();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMappingDirection' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection.countRepositoryMappingDirectionsByExternalApp(obj.getRepositoryMapping().getExternalApp());
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/repositorymappingdirections/";
        List<RepositoryMappingDirection> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment, RepositoryMappingDirectionList.class);
    ...
    public void testCountDirectionScope() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection obj = dod.getRandomRepositoryMappingDirection();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMappingDirection' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection.countRepositoryMappingDirectionsByExternalAppAndDirection(obj.getRepositoryMapping().getExternalApp(), obj.getDirection());
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/repositorymappingdirections/";
        List<RepositoryMappingDirection> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment + obj.getDirection() + "/", RepositoryMappingDirectionList.class);
        org.junit.Assert.assertTrue("Counter for 'RepositoryMappingDirection' incorrectly reported there were no entries", count > 0);
        org.junit.Assert.assertNotNull("Find entries method for 'RepositoryMappingDirection' illegally returned null", result);
        org.junit.Assert.assertEquals("Find entries method for 'RepositoryMappingDirection' returned an incorrect number of entries", count, result.size());
    }
    ...
    public void testCountRepositoryMappingScope() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection obj = dod.getRandomRepositoryMappingDirection();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMappingDirection' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection.countRepositoryMappingDirectionsByRepositoryMapping(obj.getRepositoryMapping());
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/repositorymappings/" + obj.getRepositoryMapping().getId() + "/repositorymappingdirections/";
        List<RepositoryMappingDirection> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment, RepositoryMappingDirectionList.class);
        org.junit.Assert.assertTrue("Counter for 'RepositoryMappingDirection' incorrectly reported there were no entries", count > 0);
        org.junit.Assert.assertNotNull("Find entries method for 'RepositoryMappingDirection' illegally returned null", result);
        org.junit.Assert.assertEquals("Find entries method for 'RepositoryMappingDirection' returned an incorrect number of entries", count, result.size());
    ...
    public void testCountRepositoryMappingAndDirectionScope() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection obj = dod.getRandomRepositoryMappingDirection();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMappingDirection' failed to initialize correctly", obj);
        long count = com.collabnet.ccf.ccfmaster.server.domain.RepositoryMappingDirection.countRepositoryMappingDirectionsByRepositoryMappingAndDirection(obj.getRepositoryMapping(), obj.getDirection());
        String linkIdPathSegment = "/linkid/" + obj.getRepositoryMapping().getExternalApp().getLinkId() + "/repositorymappings/" + obj.getRepositoryMapping().getId() + "/repositorymappingdirections/";
        List<RepositoryMappingDirection> result = restTemplate.getForObject(ccfAPIUrl + linkIdPathSegment + obj.getDirection(), RepositoryMappingDirectionList.class);
        org.junit.Assert.assertTrue("Counter for 'RepositoryMappingDirection' incorrectly reported there were no entries", count > 0);
        org.junit.Assert.assertNotNull("Find entries method for 'RepositoryMappingDirection' illegally returned null", result);
    ...
    public void testWithWrongGrandparentIdInPath() {
        ...
        ea.persist();
        String linkIdPathSegment = "/linkid/" + ea.getLinkId() + "/repositorymappingdirections/";
    ...
    public void testCreate() {
    	com.collabnet.ccf.ccfmaster.server.domain.RepositoryMapping randomObject = dodRM.getRandomRepositoryMapping();
    	org.junit.Assert.assertNotNull("Data on demand for 'RepositoryMappingDirection' failed to initialize correctly", randomObject);
    	String linkIdPathSegment = "/linkid/" + randomObject.getExternalApp().getLinkId() + "/repositorymappingdirections/";
        ...
        obj = restTemplate.postForObject(ccfAPIUrl + linkIdPathSegment, obj, RepositoryMappingDirection.class);

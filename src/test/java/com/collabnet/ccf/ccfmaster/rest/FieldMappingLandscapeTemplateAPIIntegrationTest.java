...
public class FieldMappingLandscapeTemplateAPIIntegrationTest extends AbstractAPIIntegrationTest {
    ...
    public void testCount() {
        org.junit.Assert
                .assertNotNull(
                        ...
                        dod.getRandomFieldMappingLandscapeTemplate());
        ...
        org.junit.Assert
                .assertTrue(
                        "Counter for 'FieldMappingLandscapeTemplate' incorrectly reported there were no entries",
                        count > 0);
        org.junit.Assert
                .assertNotNull(
                        "Find entries method for 'FieldMappingLandscapeTemplate' illegally returned null",
                        result);
        org.junit.Assert
                .assertEquals(
                        "Find entries method for 'FieldMappingLandscapeTemplate' returned an incorrect number of entries",
                        count, result.size());
    }
    ...
    public void testCreate() {
        ...
        org.junit.Assert
                .assertNotNull(
                        "Data on demand for 'FieldMappingLandscapeTemplate' failed to provide a new transient entity",
                        obj);
        org.junit.Assert
                .assertNull(
                        "Expected 'FieldMappingLandscapeTemplate' identifier to be null",
                        obj.getId());
        ...
        org.junit.Assert
                .assertNotNull(
                        "Expected 'FieldMappingLandscapeTemplate' identifier to no longer be null",
                        obj.getId());
    }
    ...
    public void testFind() {
        ...
        org.junit.Assert
                .assertEquals(
                        "Find method for 'FieldMappingLandscapeTemplate' returned the incorrect identifier",
                        id, obj.getId());
    }
    ...
    public void testUpdate() {
        ...
        org.junit.Assert
                .assertTrue(
                        "Version for 'FieldMappingLandscapeTemplate' failed to increment on flush directive",

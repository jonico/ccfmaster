...
public class FieldMappingExternalAppTemplateAPIIntegrationTest extends AbstractAPIIntegrationTest {
    ...
    public void testCount() {
        ...
        org.junit.Assert.assertNotNull("Data on demand for 'FieldMappingExternalAppTemplate' failed to initialize correctly", dod.getRandomFieldMappingExternalAppTemplate());
        List<FieldMappingExternalAppTemplate> result = restTemplate.getForObject(ccfAPIUrl + "/fieldmappingexternalapptemplates", FieldMappingExternalAppTemplateList.class);
    ...
    public void testUpdate() {
        ...
        restTemplate.put(ccfAPIUrl + "/fieldmappingexternalapptemplates/"+ id, obj);
        obj = restTemplate.getForObject(ccfAPIUrl + "/fieldmappingexternalapptemplates/"+ id, FieldMappingExternalAppTemplate.class);
    ...
    public void testWrongUpdate() {
        ...
        org.junit.Assert.assertNotNull("Find method for 'FieldMappingExternalAppTemplate' illegally returned null for id '" + id + "'", obj);
        restTemplate.put(ccfAPIUrl + "/fieldmappingexternalapptemplates/"+ id, obj);
        obj = restTemplate.getForObject(ccfAPIUrl + "/fieldmappingexternalapptemplates/"+ id + 42, FieldMappingExternalAppTemplate.class);
    ...
    public void testCreate() {
        ...
        obj = restTemplate.postForObject(ccfAPIUrl + "/fieldmappingexternalapptemplates/", obj, FieldMappingExternalAppTemplate.class);
    ...
    public void testRemove() {
        ...
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'FieldMappingExternalAppTemplate' failed to provide an identifier", id);
        restTemplate.delete(ccfAPIUrl + "/fieldmappingexternalapptemplates/"+ id);
        try {
        	obj = restTemplate.getForObject(ccfAPIUrl + "/fieldmappingexternalapptemplates/"+ id, FieldMappingExternalAppTemplate.class);
